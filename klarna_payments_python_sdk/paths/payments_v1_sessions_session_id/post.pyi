...
from klarna_payments_python_sdk.model.session import Session as SessionSchema
from klarna_payments_python_sdk.model.session_custom_payment_method_ids import SessionCustomPaymentMethodIds as SessionCustomPaymentMethodIdsSchema
...
from klarna_payments_python_sdk.type.session import Session
...
from klarna_payments_python_sdk.pydantic.session_custom_payment_method_ids import SessionCustomPaymentMethodIds as SessionCustomPaymentMethodIdsPydantic
...
from klarna_payments_python_sdk.pydantic.session import Session as SessionPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SessionSchema


request_body_session = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_session_details_mapped_args(
        self,
        session_id: str,
        ...
        custom_payment_method_ids: typing.Optional[SessionCustomPaymentMethodIds] = None,
        ...
        order_amount: typing.Optional[int] = None,
        order_lines: typing.Optional[typing.List[OrderLine]] = None,
        ...
        purchase_country: typing.Optional[str] = None,
        purchase_currency: typing.Optional[str] = None,
    ...
    async def _aupdate_session_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/payments/v1/sessions/{session_id}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_session.serialize(body, content_type)
    ...
    def _update_session_details_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSessionDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_session_details(
        self,
        session_id: str,
        acquiring_channel: typing.Optional[str] = None,
        attachment: typing.Optional[Attachment] = None,
        ...
        **kwargs,
        ...
        args = self._update_session_details_mapped_args(
        ...
        return await self._aupdate_session_details_oapg(
            body=args.body,
    ...
    def update_session_details(
        ...
        return self._update_session_details_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSessionDetails(BaseApi):
    ...
    async def aupdate_session_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_session_details(
            session_id=session_id,
            acquiring_channel=acquiring_channel,
            attachment=attachment,
            authorization_token=authorization_token,
    ...
    def update_session_details(
        ...
        raw_response = self.raw.update_session_details(
            session_id=session_id,
            acquiring_channel=acquiring_channel,
            attachment=attachment,
            authorization_token=authorization_token,
