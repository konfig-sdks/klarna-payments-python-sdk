...
from klarna_payments_python_sdk.pydantic.session_create_custom_payment_method_ids import SessionCreateCustomPaymentMethodIds
...
class SessionCreate(BaseModel):
    ...
    custom_payment_method_ids: typing.Optional[SessionCreateCustomPaymentMethodIds] = Field(None, alias='custom_payment_method_ids')
