...
from klarna_payments_python_sdk.pydantic.customer_read import CustomerRead
...
from klarna_payments_python_sdk.pydantic.session_read_custom_payment_method_ids import SessionReadCustomPaymentMethodIds
...
class SessionRead(BaseModel):
    ...
    custom_payment_method_ids: typing.Optional[SessionReadCustomPaymentMethodIds] = Field(None, alias='custom_payment_method_ids')

    customer: typing.Optional[CustomerRead] = Field(None, alias='customer')
