...
class MerchantUrls(BaseModel):
    ...
    confirmation: typing.Optional[str] = Field(None, alias='confirmation')
    ...
    push: typing.Optional[str] = Field(None, alias='push')

    # URL for receiving the authorization token when payment is completed. Used for Authorization Callback.
    authorization: typing.Optional[str] = Field(None, alias='authorization')
    class Config:
