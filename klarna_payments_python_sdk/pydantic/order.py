...
from klarna_payments_python_sdk.pydantic.authorized_payment_method import AuthorizedPaymentMethod
...
class Order(BaseModel):
    ...
    authorized_payment_method: typing.Optional[AuthorizedPaymentMethod] = Field(None, alias='authorized_payment_method')
    ...
    fraud_status: typing.Optional[str] = Field(None, alias='fraud_status')
