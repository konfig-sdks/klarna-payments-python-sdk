...
class Customer(BaseModel):
    ...
    last_four_ssn: typing.Optional[str] = Field(None, alias='last_four_ssn')
    ...
    national_identification_number: typing.Optional[str] = Field(None, alias='national_identification_number')
