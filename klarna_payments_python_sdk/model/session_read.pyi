...
class SessionRead(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def custom_payment_method_ids() -> typing.Type['SessionReadCustomPaymentMethodIds']:
                return SessionReadCustomPaymentMethodIds
        
            @staticmethod
            def customer() -> typing.Type['CustomerRead']:
                return CustomerRead
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["custom_payment_method_ids"]) -> 'SessionReadCustomPaymentMethodIds': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["customer"]) -> 'CustomerRead': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["acquiring_channel", "attachment", "authorization_token", "billing_address", "client_token", "custom_payment_method_ids", "customer", "design", "expires_at", "locale", "merchant_data", "merchant_reference1", "merchant_reference2", "merchant_urls", "options", "order_amount", "order_lines", "order_tax_amount", "payment_method_categories", "purchase_country", "purchase_currency", "shipping_address", "status", "intent", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["custom_payment_method_ids"]) -> typing.Union['SessionReadCustomPaymentMethodIds', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["customer"]) -> typing.Union['CustomerRead', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["order_amount"]) -> typing.Union[MetaOapg.properties.order_amount, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["order_lines"]) -> typing.Union[MetaOapg.properties.order_lines, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["purchase_country"]) -> typing.Union[MetaOapg.properties.purchase_country, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["purchase_currency"]) -> typing.Union[MetaOapg.properties.purchase_currency, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        custom_payment_method_ids: typing.Union['SessionReadCustomPaymentMethodIds', schemas.Unset] = schemas.unset,
        customer: typing.Union['CustomerRead', schemas.Unset] = schemas.unset,
        ...
        order_amount: typing.Union[MetaOapg.properties.order_amount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        order_lines: typing.Union[MetaOapg.properties.order_lines, list, tuple, schemas.Unset] = schemas.unset,
        ...
        purchase_country: typing.Union[MetaOapg.properties.purchase_country, str, schemas.Unset] = schemas.unset,
        purchase_currency: typing.Union[MetaOapg.properties.purchase_currency, str, schemas.Unset] = schemas.unset,
