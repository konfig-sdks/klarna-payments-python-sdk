...
from klarna_payments_python_sdk.type.customer_read import CustomerRead
...
from klarna_payments_python_sdk.type.session_read_custom_payment_method_ids import SessionReadCustomPaymentMethodIds

class RequiredSessionRead(TypedDict):
    pass

class OptionalSessionRead(TypedDict, total=False):
    ...
    custom_payment_method_ids: SessionReadCustomPaymentMethodIds
...
class SessionRead(RequiredSessionRead, OptionalSessionRead):
    pass
