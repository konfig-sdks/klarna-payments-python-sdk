...
from klarna_payments_python_sdk.type.asset_urls import AssetUrls

class RequiredPaymentMethodCategory(TypedDict):
    pass

class OptionalPaymentMethodCategory(TypedDict, total=False):
...
class PaymentMethodCategory(RequiredPaymentMethodCategory, OptionalPaymentMethodCategory):
    pass
