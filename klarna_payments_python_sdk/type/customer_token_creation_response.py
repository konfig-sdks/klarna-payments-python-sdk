...
from klarna_payments_python_sdk.type.customer_read_create_token import CustomerReadCreateToken

class RequiredCustomerTokenCreationResponse(TypedDict):
...
class OptionalCustomerTokenCreationResponse(TypedDict, total=False):
...
class CustomerTokenCreationResponse(RequiredCustomerTokenCreationResponse, OptionalCustomerTokenCreationResponse):
    pass
